...
S.append(dict(kind="content", eyebrow="Venture economics",
    ...
    rows=[("AED 200k", "launch contribution", "Paid in full on signing"),
...
S.append(dict(kind="content", eyebrow="Funding bridge",
    title="AED 200k mobilises the venture, not the office",
...
S.append(dict(kind="content", eyebrow="First 90 days",
    ...
    lettered=[("01", "Sign + set up", "Pay AED 200k · instruct Thai counsel · file the DTV and work plan"),
